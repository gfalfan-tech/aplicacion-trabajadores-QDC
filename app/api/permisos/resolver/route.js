...
// Aprueba o rechaza una solicitud de permiso. Puede hacerlo la jefatura
// directa de la persona, o RR.HH./administrador. Mismo patrón que
// /api/vacaciones/resolver.
  ...
  const { error } = await admin
    ...
    .update({
      ...
      comentario_resolucion:
        estado === 'rechazada' ? 'Favor dirigirse personalmente con su jefatura.' : null,
    })
    .eq('id', solicitudId);
