...
export function dibujarSelloEstado(doc, estado, anchoPagina, y, motivo) {
...
export function dibujarFirmasVacaciones(doc, anchoPagina, y, { jefeNombre, segundoFirmante, trabajadorNombre }) {
...
export function dibujarFirmasRendicionGastos(doc, anchoPagina, y, { jefeNombre, trabajadorNombre }) {
  const centroIzq = anchoPagina / 2 - 45;
  const centroDer = anchoPagina / 2 + 45;
  const anchoLineaFirma = 60;
