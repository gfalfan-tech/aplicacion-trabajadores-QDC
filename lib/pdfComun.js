...
export async function dibujarFirmasVacaciones(
  ...
  dibujarLineaFirma(doc, centroDer, yLineaSuperior, anchoLineaFirma, segundoFirmante, 'Autorizado por · RR.HH.', compacto);
  await dibujarTimbre(doc, timbre, centroDer, yLineaSuperior - (compacto ? 7 : 10), compacto ? 17 : 24);

  return yLineaSuperior + (compacto ? 5 : 12);
}
